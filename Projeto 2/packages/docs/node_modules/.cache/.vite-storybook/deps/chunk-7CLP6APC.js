...
import {
  stringify
} from "./chunk-6SYW36LS.js";
import {
  SNIPPET_RENDERED,
  SourceType,
  str
} from "./chunk-JON53U7S.js";
import {
  esm_default
...
import {
  ...
  rgba
} from "./chunk-VYSWWBEP.js";
import {
  require_uniq
} from "./chunk-JT3LHXTV.js";
import {
  index_modern_default
} from "./chunk-EO2YJYWK.js";
import {
  require_pickBy
} from "./chunk-KLTMSYMS.js";
import {
  require_mapValues
} from "./chunk-LOAX7DVX.js";
import {
  require_cloneDeep
} from "./chunk-6G5VGNBX.js";
import {
  renderElement,
  unmountElement
} from "./chunk-T2RQXUAN.js";
import {
  require_preview_api
} from "./chunk-THRUGBOO.js";
import {
  ThemeProvider,
  convert,
...
var Preview = ({ isLoading, isColumn, columns, children, withSource, withToolbar = false, isExpanded = false, additionalActions, className, layout = "padded", ...props }) => {
  let [expanded, setExpanded] = (0, import_react.useState)(isExpanded), { source, actionItem } = getSource(withSource, expanded, setExpanded), [scale, setScale] = (0, import_react.useState)(1), previewClasses = [className].concat(["sbdocs", "sbdocs-preview", "sb-unstyled"]), defaultActionItems = withSource ? [actionItem] : [], [additionalActionItems, setAdditionalActionItems] = (0, import_react.useState)(additionalActions ? [...additionalActions] : []), actionItems = [...defaultActionItems, ...additionalActionItems], { window: globalWindow4 } = scope, copyToClipboard = (0, import_react.useCallback)(async (text) => {
    let { createCopyToClipboardFunction } = await import("./dist-IP32QCAC.js");
...
var MultiSelect = ({ name, value: value2, options, onChange }) => {
  ...
  return import_react.default.createElement(SelectWrapper, null, import_react.default.createElement(OptionsSelect, { id: controlId, multiple: true, value: selection, onChange: handleChange }, Object.keys(options).map((key) => import_react.default.createElement("option", { key }, key))));
};
...
var RangeInput = emotion_styled_browser_esm_default.input(({ theme, min, max, value: value2 }) => ({ "&": { width: "100%", backgroundColor: "transparent", appearance: "none" }, "&::-webkit-slider-runnable-track": { background: theme.base === "light" ? `linear-gradient(to right, 
...
var LazyColorControl = (0, import_react.lazy)(() => import("./Color-3YIJY6X7-JC54LINX.js"));
...
var ArgRow = (props) => {
  ...
  return import_react.default.createElement("tr", null, import_react.default.createElement(StyledTd, { expandable }, import_react.default.createElement(Name, null, name), required ? import_react.default.createElement(Required, { title: "Required" }, "*") : null), compact ? null : import_react.default.createElement("td", null, hasDescription && import_react.default.createElement(Description, null, import_react.default.createElement(index_modern_default, null, description)), table.jsDocTags != null ? import_react.default.createElement(import_react.default.Fragment, null, import_react.default.createElement(TypeWithJsDoc, { hasDescription }, import_react.default.createElement(ArgValue, { value: type, initialExpandedArgs })), import_react.default.createElement(ArgJsDoc, { tags: table.jsDocTags })) : import_react.default.createElement(Type, { hasDescription }, import_react.default.createElement(ArgValue, { value: type, initialExpandedArgs }))), compact ? null : import_react.default.createElement("td", null, import_react.default.createElement(ArgValue, { value: defaultValue, initialExpandedArgs })), updateArgs ? import_react.default.createElement("td", null, import_react.default.createElement(ArgControl, { ...props })) : null);
};
...
var rowLoadingData = (key) => ({ key, name: "propertyName", description: "This is a short description", control: { type: "text" }, table: { type: { summary: "summary" }, defaultValue: { summary: "defaultValue" } } });
...
var ArgsTable = (props) => {
  if ("error" in props)
    return import_react.default.createElement(EmptyBlock, null, props.error, " ", import_react.default.createElement(Link2, { href: "http://storybook.js.org/docs/", target: "_blank", withArrow: true }, "Read the docs"));
  let { updateArgs, resetArgs, compact, inAddonPanel, initialExpandedArgs, sort = "none" } = props, isLoading = "isLoading" in props, { rows, args, globals } = "rows" in props ? props : argsTableLoadingData, groups = groupRows((0, import_pickBy.default)(rows, (row) => {
    var _a;
  ...
  if (groups.ungrouped.length === 0 && Object.entries(groups.sections).length === 0 && Object.entries(groups.ungroupedSubsections).length === 0)
    return import_react.default.createElement(EmptyBlock, null, "No inputs found for this component. ", import_react.default.createElement(Link2, { href: "http://storybook.js.org/docs/", target: "_blank", withArrow: true }, "Read the docs"));
  let colSpan = 1;
...
var SourceContainer = ({ children, channel }) => {
  ...
  return (0, import_react.useEffect)(() => {
    let handleSnippetRendered = (idOrEvent, inputSource = null, inputFormat = false) => {
      ...
      sources[id] && sources[id][hash] && sources[id][hash].code === source || setSources((current) => {
        let newSources = { ...current, [id]: { ...current[id], [hash]: { code: source, format: format2 } } };
...
var DocsRenderer = class {
  constructor() {
    this.render = async (context, docsParameter, element) => {
      ...
      return new Promise((resolve, reject) => {
        import("./@mdx-js_react.js").then(({ MDXProvider }) => renderElement(import_react2.default.createElement(ErrorBoundary, { showException: reject, key: Math.random() }, import_react2.default.createElement(MDXProvider, { components }, import_react2.default.createElement(Docs, { context, docsParameter }))), element)).then(resolve);
      });
...
//# sourceMappingURL=chunk-7CLP6APC.js.map
