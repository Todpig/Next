import {
  require_throttle
} from "./chunk-TUEPYNHC.js";
import "./chunk-AC6ANPRI.js";
import {
  require_color_convert
} from "./chunk-7WAAI4KB.js";
import {
  getControlId
...
import "./chunk-7M7LYQLC.js";
import "./chunk-C5QDBJ46.js";
import "./chunk-ILRUBH6T.js";
import "./chunk-MFCSO543.js";
import "./chunk-YHF4DAK7.js";
import "./chunk-MIGPBO42.js";
import "./chunk-2WIBUKJR.js";
import "./chunk-NYE64GNP.js";
import "./chunk-BAVOW2FU.js";
import "./chunk-QIXIUM3H.js";
import {
  emotion_styled_browser_esm_default
} from "./chunk-VWLQGJBP.js";
import "./chunk-Z3Z6UNRZ.js";
import "./chunk-EO7CBCZV.js";
...
var Wrapper = emotion_styled_browser_esm_default.div({ position: "relative", maxWidth: 250 });
var PickerTooltip = emotion_styled_browser_esm_default(WithTooltip)({ position: "absolute", zIndex: 1, top: 4, left: 4 });
var TooltipContent = emotion_styled_browser_esm_default.div({ width: 200, margin: 5, ".react-colorful__saturation": { borderRadius: "4px 4px 0 0" }, ".react-colorful__hue": { boxShadow: "inset 0 0 0 1px rgb(0 0 0 / 5%)" }, ".react-colorful__last-control": { borderRadius: "0 0 4px 4px" } });
var Note = emotion_styled_browser_esm_default(TooltipNote)(({ theme }) => ({ fontFamily: theme.typography.fonts.base }));
var Swatches = emotion_styled_browser_esm_default.div({ display: "grid", gridTemplateColumns: "repeat(9, 16px)", gap: 6, padding: 3, marginTop: 5, width: 200 });
var SwatchColor = emotion_styled_browser_esm_default.div(({ theme, active }) => ({ width: 16, height: 16, boxShadow: active ? `${theme.appBorderColor} 0 0 0 1px inset, ${theme.textMutedColor}50 0 0 0 4px` : `${theme.appBorderColor} 0 0 0 1px inset`, borderRadius: theme.appBorderRadius }));
...
var Input = emotion_styled_browser_esm_default(Form.Input)(({ theme }) => ({ width: "100%", paddingLeft: 30, paddingRight: 30, boxSizing: "border-box", fontFamily: theme.typography.fonts.base }));
var ToggleIcon = emotion_styled_browser_esm_default(Icons)(({ theme }) => ({ position: "absolute", zIndex: 1, top: 6, right: 7, width: 20, height: 20, padding: 4, boxSizing: "border-box", cursor: "pointer", color: theme.input.color }));
...
//# sourceMappingURL=Color-3YIJY6X7-JC54LINX.js.map
